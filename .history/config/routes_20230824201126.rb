...
Rails.application.routes.draw do
  ...
  resources :accounts do
    member do
      post 'like_user_post/:post_id', to: 'likes#like_user_post', as: :like_user_post
      delete 'unlike_user_post/:post_id',  as: :unlike_user_post , as: :unlike_user_post
    end
  end
 # post 'like_user_post/:post_id',  as: :like_user_post
