...
class AccountsController < ApplicationController
  ...
  def show_all
    # Fetch accounts that are private (private: true) and have followers with accepted: false
accounts = Account.joins(:followers).where(private: true, followers: { accepted: false }).distinct
