...
class PostsController < ApplicationController
  ...
  # Update both description and private attributes
  ...
  @post = Post.find(params[:id]) # Assuming you've already loaded the post.
  @description_changed = params[:post][:description].present?
  @images_changed = params[:post][:images].present?

  # Update description, private, and images attributes
