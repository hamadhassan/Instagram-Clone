...
class AccountsController < ApplicationController
  ...
  def accept_follow_request
    ...
    # Assuming you want to update the current_account's follower status
    current_account.update(following_id: following_account.id, accepted: true)

    # You might want to handle errors here, e.g., if current_account or following_account is not found.
  end
