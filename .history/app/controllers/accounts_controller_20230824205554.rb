...
class AccountsController < ApplicationController
  ...
  def like_user_post
    ...
    like = @post.likes.create(account_id: current_account.id, liked: true) if pre_like

    # if pre_like
    #   # If the user has already liked the post, do nothing or show a message
  ...
  def unlike_user_post
    ...
    # Find and destroy the like if it exists
    ...
    if like
      ...
      # Handle the case where the like doesn't exist (e.g., user hasn't liked it)
      flash[:error] = 'You cannot unlike a post you haven\'t liked.'
    end
