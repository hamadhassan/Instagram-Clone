...
class PostsController < ApplicationController
  ...
  def update
    ...
    # Retrieve the current images associated with the post
    ...
    if @post.update(post_params)
      ...
      elsif previous_images.any?
        # User has not uploaded new images, and there are previous images; reattach them
        @post.images.attach(previous_images)
      end
