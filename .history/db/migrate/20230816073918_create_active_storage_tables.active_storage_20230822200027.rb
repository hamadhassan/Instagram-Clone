...
class CreateActiveStorageTables < ActiveRecord::Migration[5.2]
  ...
  def create_active_storage_blobs_table(primary_key_type)
    create_table :active_storage_blobs, id: primary_key_type, &method(:configure_blob_table)
  end

  def create_active_storage_attachments_table(primary_key_type, foreign_key_type)
    create_table :active_storage_attachments, id: primary_key_type, &method(:configure_attachments_table)
  end

  def create_active_storage_variant_records_table(primary_key_type, foreign_key_type)
    create_table :active_storage_variant_records, id: primary_key_type, &method(:configure_variant_records_table)
  end

  def configure_blob_table(t)
  ...
  def configure_attachments_table(t)
  ...
  def configure_variant_records_table(t)
